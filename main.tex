...
We remark that the symmetric matrix of Definition~\ref{def:mathom} has a diagonal of zeroes if the underlying field characteristic is even. Now, we recall two essential building blocks of cryptography, with definitions taken from~\cite{} and~\cite{}.
...
The bipolar construction creates a situation in which the schemes
derived from it are not exclusively based on the polynomial system solving
