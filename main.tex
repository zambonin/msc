...
The bipolar construction creates a situation in which its derived schemes are not exclusively based on the polynomial system solving problem. Instead, it is proven~\cite{Wolf:201104} that there exist many private keys that
