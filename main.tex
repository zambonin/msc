...
Consider a finite field $\mathbb{F}_{q}$ and $v, o \in \mathbb{N}$. These integers represent the quantity of vinegar and oil variables, respectively. The total number of variables is $n = v + o$. Intuitively, they may be divided as $\mathbf{x} = (x_{1}, \dots, x_{v}, x'_{1}, \dots, x'_{o})$, or simply $\mathbf{x} = (x_{1}, \dots, x_{v}, x_{v + 1}, \dots, x_{v + o})$.
...
\begin{definition}
  ...
  \begin{align}
    \sum_{i = 1}^{v} \sum_{j = 1}^{v} \alpha x_{i} x_{j} + \sum_{i = 1}^{v} \sum_{j = 1}^{o} \beta x_{i} x'_{j} + \sum_{}
  \end{align}
