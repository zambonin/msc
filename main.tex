...
With the pure mathematical machinery defined, we now introduce the building blocks to create a generic digital signature scheme based on multivariate polynomial equations. Indeed, multivariate public key cryptography also encompasses public-key encryption, but those are outside of the scope of this work.
