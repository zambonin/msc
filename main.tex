...
Recent developments of Rainbow cryptanalysis, as summarized in~\cite{} have improved the complexity of Rainbow-Band-Separation and MinRank attacks. Due to the lack of precise formulas for the case of Rainbow, we present the results in the second pat of Table~\ref{tab:sec} as given by the authors of the works. We refer to the revised parameters simply by the highest NIST category 
