...
The main observation of the attack is given in~\cite[Lemma~4]{Kipnis:199808}. It states that combinations of matrices, each of which is associated with each polynomial system of $\mathcal{C}$ through Definition~\ref{def:ovh-matrix}, are specifically structured. This carries over to the public key, and thus can be used by the attacker to produce an equivalent key and forge signatures.
