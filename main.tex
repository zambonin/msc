...
Segurança nas comunicações entre dispositivos eletrônicos é um requisito frequentemente desejado, em vista do acréscimo exponencial de troca digital de informações a cada dia. Neste contexto, a criptografia de chaves públicas fornece arcabouços matemáticos para diferentes situações. Esquemas de assinatura digital são utilizados para prover autenticidade, integridade e não-repúdio de mensagens e seus remetentes. 
