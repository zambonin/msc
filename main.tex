...
\begin{align}
  \begin{split}
    ...
    \begin{bmatrix}
      ...
      % TODO check
      \omega^{(1^{-1} \cdot 3^{-1} \cdot 2 \cdot 5 -3 \cdot 4 \cdot 6^{-1})} & \omega^{(-6^{-1} \cdot 5 \cdot 3^{-1})} & (\omega^{(6)})^{-1} \\
    \end{bmatrix}.
  \end{split}
\end{align}
