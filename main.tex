...
In this chapter, we will describe the research strategy applied to produce this work. We will thus derive the main research question, obtain the related literature and finally apply several methods in order to infer conclusions. This process is done using a deductive method,
