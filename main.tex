...
In this chapter, we will describe the research strategy applied to produce this work. We will define the main research question, obtain the related body of literature, and finally apply several methods in order to infer conclusions. Indeed, this is essentially a description of the usual scientific method. Thus, we use 
