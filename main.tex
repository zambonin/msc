...
We observe that there are very few signature schemes based on Rainbow that attempt to reduce both private and public keys at the same time. The conventional procedure of generating the public key from the corresponding private key is prevalent. Additionally, the method of Petzoldt that is based on generating a public key first and obtaining the central map later, is the basis of all public key reduction methods in the literature.
