...
\begin{align*}
  \widetilde{M}(p) = \begin{bmatrix}
    ...
    \vdots & \ddots & \vdots & \vdots & \ddots & \vdots \\
    \star & \cdots & \star & 0 & \cdots & 0 \\
  \end{bmatrix}, $p \in \mathsf{OVP}(n) \cap \mathsf{MHQ}(n)$
\end{align*}
