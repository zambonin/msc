...
This concept can be evidently expanded to accommodate more variables. However, we refrain from showing the full generalized summation that defines the new polynomial expression, since it is hard to follow even for a bivariate polynomial.
