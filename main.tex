...
the number of elements in the matrix representations of \mathcal{S} and \mathcal{T}, as well as every coefficient from each layer of Oil--Vinegar polynomials as per Equation~\ref{}. In other words,
\begin{align}
