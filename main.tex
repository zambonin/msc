...
In the context of multivariate cryptography, monomial ordering is used to define matrix representations of multivariate polynomials, and to solve polynomial systems using Gröbner bases~\cite{}. As seen in Section~\ref{}, the visualization and manipulation of multivariate polynomials as matrices is helpful in understanding and even attacking some cryptosystems. 
