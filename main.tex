...
\begin{figure}[htbp]
  \begin{chronology}[startyear=2005, stopyear=2019, height=3pt, dates=false, arrow=false, align=center]
    ...
    \chronosp[]{09/2006}{Class~\ref{enum:iv}~\cite{Billet:200609:inproc}}
    \chronosp[markdepth=50pt]{06/2008}{Class~\ref{enum:iv}~\cite{Ding:200806:inproc}}
    \chronosp[markdepth=-60pt]{06/2010}{Class~\ref{enum:ii}~\cite{Petzoldt:201006:inproc}}
    \chronosp[colorbox=green!10,markdepth=130pt]{12/2010}{Class~\ref{enum:i}~\cite{Petzoldt:201012:inproc}}
    \chronosp[markdepth=-20pt]{03/2011}{Class~\ref{enum:ii}~\cite{Petzoldt:201103:inproc}}
    \chronosp[colorbox=green!10,markdepth=90pt]{09/2011}{Class~\ref{enum:i}~\cite{Petzoldt:inproc:2011:sep}}
    \chronosp[colorbox=red!10,markdepth=-100pt]{02/2012}{YST~\cite{Yasuda:inproc:2012:feb}}
    \chronosp[markdepth=-60pt]{09/2012}{Class~\ref{enum:iv}~\cite{Thomae:201209:inproc}}
    \chronosp[colorbox=green!10]{11/2012}{Class~\ref{enum:i}~\cite{Petzoldt:inproc:2012:nov}}
    \chronosp[markdepth=-60pt]{2/2013}{Class~\ref{enum:iv}~\cite{Hashimoto:201302:inproc}}
    \chronosp[markdepth=50pt]{5/2013}{Class~\ref{enum:ii}~\cite{Yasuda:201305:inproc}}
    \chronosp[colorbox=green!10]{7/2013}{Class~\ref{enum:i}~\cite{Petzoldt:phd:2013:jul}}
    \chronosp[colorbox=green!10,markdepth=-60pt]{1/2014}{Class~\ref{enum:i}~\cite{Yasuda:article:2014:jan}}
    \chronosp[]{4/2014}{Class~\ref{enum:ii}~\cite{Yasuda:201404:inproc}}
    \chronosp[markdepth=-20pt]{9/2014}{Class~\ref{enum:ii}~\cite{Yasuda:201409:article}}
    \chronosp[colorbox=green!10]{12/2015}{Class~\ref{enum:i}~\cite{Shim:inproc:2015:dec}}
    \chronosp[colorbox=green!10,markdepth=50pt]{6/2017}{Class~\ref{enum:i}~\cite{Beullens:msc:2017:jun}}
    \chronosp[colorbox=red!10,markdepth=-60pt]{6/2017}{PT~\cite{Peng:article:2017:jun}}
    \chronosp[colorbox=green!10]{6/2017}{Class~\ref{enum:i}~\cite{Szepieniec:inproc:2017:jun}}
    \chronosp[colorbox=green!10,markdepth=-20pt]{12/2017}{Class~\ref{enum:i}~\cite{Beullens:inproc:2017:dec}}
    \chronosp[markdepth=-20pt]{10/2018}{Class~\ref{enum:iv}~\cite{Hashimoto:201810:misc}}
  \end{chronology}
