...
In this Section, we describe the classic schemes based on the Oil--Vinegar trapdoor, introduced in~\cite{Patarin:199709}. We define the Unbalanced Oil and Vinegar (UOV) signature scheme, alongside with its multi-layer generalization, Rainbow. We discuss the theory of equivalent keys for each scheme and the known cryptanalytic toolbox for challenging the security of such schemes.
