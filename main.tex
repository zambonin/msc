...
This approach is based on the fact that a private key owner is able to recover the original $\mathcal{C}$ through the possession of all other private maps and
