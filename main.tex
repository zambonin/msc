...
Let $\mathcal{U}(1, q)$ be the discrete uniform distribution that represents the chance of picking an element from $\mathbb{F}$. We note that if the field characteristic is even, there exists a mapping to the natural numbers that allows this choice to be performed. Thus, it is expected that
\begin{align}
...
Let us denote the absolute difference between standard deviations for
