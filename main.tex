...
\begin{definition}
  ...
  \begin{enumerate}
    ...
    \item For any $g_{1} \in G$, there exists an element $e \in G$, called \emph{identity of $G$}, such that $g_{1} \star e = e \star g_{1} = g_{1}$.
    \item For any $g_{1} \in G$, there exists an element $g_{1}^{-1} \in G$, called an \emph{inverse of $g_{1}$}, such that $g_{1} \star g_{1}^{-1} = g_{1}^{-1} \star g_{1} = e$.
  \end{enumerate}
\end{definition}
...
We remark some technicalities about these definitions. The axiom of 
