...
By precisely choosing a target, an attacker may increase the odds of obtaining useful signatures for the attack. However, for all intents and purposes, we will observe the probability of carrying on with the attack for various values of $\alpha$. 
