...
Rainbow is evidently the most known multivariate signature scheme based on Oil--Vinegar polynomials. However, schemes of that class with modifications that enable the reduction of key sizes have been suggested even before Rainbow was created. Chronologically, we observe that the first schemes with this goal in mind were called \emph{stepwise triangular systems} in their generalized form~\cite{}. The inherent shape of private keys in that class of schemes, in which there are r
