...
We note that the matrix representation of $\mathcal{P}$ itself is highly dependant on a monomial ordering~\cite{}. On the other hand, the matrix of Definition~\ref{def:matquad} does not necessarily need a monomial order, but the resulting product may differ from the original polynomial. Further, 
