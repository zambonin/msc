...
There always exists at least one basis for a vector space~\cite{}. Indeed, it is a compact way of representing the entire set of vectors. For example, the sequence of unit vectors $(1, 0, \dots, 0), \dots, (0, \dots, 0, 1)$ over $\mathbb{F}^{n}$ together form the \emph{identity matrix}, hereafter denoted as $I_{n}$.

% topics for tomorrow: polynomial maps, vector spaces
% invertible affine map -> invertible matrix
