...
Once again, we do not discard the possibility that an extension of our attack exists, that makes use of any possible leaked information in signatures independent of the number of fixed vinegar variables.
