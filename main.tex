...
In this chapter, we introduce the mathematical toolbox necessary in order to fully comprehend the remainder of this work. Section~\ref{} defines basic algebraic structures and 
