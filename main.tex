...
We assume that the number of signatures needed to attack our proposal can be improved. Our attack is based on combining pairs of signatures in order to obtain linearly independent vectors. We implemented a naive strategy that always yields symbolically linearly independent vectors. However, it may be the case that carefully picked combinations of a smaller collection of signatures can result in the desired number of vectors used to proceed with our attack.
