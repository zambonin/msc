...
\begin{definition}
  Given a multivariate cryptosystem based on the bipolar construction and public and private keys $\mathbf{pk}, (\mathcal{L}_{1}, \mathcal{C}, \mathcal{L}_{2})$, finding maps $\widetilde{\mathcal{L}_{1}}, $
