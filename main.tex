...
\begin{figure}[htbp]
  \begin{chronology}[startyear=2005, stopyear=2019, height=3pt, dates=false, arrow=false, align=center]
    ...
    \chronosp[markdepth=130pt]{12/2010}{Class~\ref{enum:i}~\cite{Petzoldt:201012:inproc}}
    ...
    \chronosp[colorbox=green!10,markdepth=50pt]{06/2017}{Class~\ref{enum:i}~\cite{Beullens:msc:2017:jun}}
    \chronosp[markdepth=-60pt]{06/2017}{Class~\ref{enum:iii}~\cite{Peng:201706:article}}
    \chronosp[colorbox=green!10]{06/2017}{Class~\ref{enum:i}~\cite{Szepieniec:inproc:2017:jun}}
