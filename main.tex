...
Unfortunately, there is little information on the difficulty of EIP~\cite[p. 69]{Thomae:201306}, preventing complete security proofs for Oil--Vinegar multivariate cryptosystems. This is also the case for other IP problems, such that most multiv
