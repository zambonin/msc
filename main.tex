...
\begin{definition}
  Given $k, n \in \mathbb{N}$, coefficients $a_{0}, \dots, a_{k} \in \mathbb{F}$ and indeterminates $\mathbf{x}$, the set 
%   The set of polynomials with coefficients in a ring $R$ form a \emph{polynomial ring}.
\end{definition}
