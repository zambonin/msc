...
\end{align}
We note that the performance of this method is lower than that of Rainbow-$\eta_{1}$, due to the efficiency of PRNGs, and the size of the aforementioned matrices with . However, it is a general technique that works on all Rainbow-like schemes.
