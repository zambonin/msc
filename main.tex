...
Like MinRank, linear combinations of public key matrices are used to find the variables that are less likely to appear in the central map. This is used to identify the last Rainbow layer and obtain the previous layers similarly. The complexity of the improved attack~\cite{Ding:200806} is $q^{o_{u}} \cdot \frac{n^{3}}{6}$ field multiplications.
