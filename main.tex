...
The security analysis performed to assert the safety of using our proposal was carried out considering that there were no changes in parameters, thus maintaining the high complexity of known attacks. Yet, we identified a flaw in our proposal that allowed an attacker to efficiently recover an equivalent key, by collecting a small number of signatures. 
