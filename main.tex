...
Cryptography is the discipline in which techniques for secure communications are studied. Historically, information was hidden from adversaries by scrambling its contents with an algorithm that received a key as input.
