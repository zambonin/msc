...
Consider the vector space $\mathbb{F}^{n}$ that denotes all possible signatures from a balanced Oil--Vinegar signature scheme, that is, $n = v + o$. We give below a characterization of two vector spaces that are essential to discuss the attack.
