...
\begin{theorem}[{\cite[Theorem 4.15]{Wolf:201104}}]
  ...
  \begin{align}
    \begin{bmatrix}
      \omega_{v \times v}^{(1)} & \omega_{v \times o}^{(2)} \\
      \omega_{o \times v}^{(3)} & \mathbf{0}_{o \times o} \\
    \end{bmatrix},
  \end{align}
  then $(\mathcal{C} \circ \omega, \omega^{-1} \circ \mathcal{L}_{2})$ is an equivalent private key.
\end{theorem}
