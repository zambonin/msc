...
\begin{table}[htbp]
  ...
  \begin{tabular}{*{2}{l}*{5}{r}}
    ...
    P-080  & $(\mathbb{F}_{256}, 17, 17,  9)$  &   43 &   26 &    16371 &    3519 &  $-78.50\%$ \\
    P-100  & $(\mathbb{F}_{256}, 26, 22, 21)$  &   69 &   43 &    68212 &   17083 &  $-74.96\%$ \\
    P-128  & $(\mathbb{F}_{256}, 36, 28, 15)$  &   79 &   43 &    94860 &   14814 &  $-84.38\%$ \\
...
We show results for the application of our method in Table~\ref{tab:1}, considering the following Rainbow instances. Conservative choices were made by the Rainbow submission authors~\cite{Ding:201712} to fit security categories as requested by NIST\@. We apply our method to these recent proposals, and additionally choose parameters from Petzoldt~\cite[Table 6.12]{Petzoldt:201307} for further comparison. The latter are named P-$\ell$, where $\ell$ is the security level in bits. 
...
\begin{table}[htbp]
  ...
  \begin{tabular}{lp{3cm}*{5}{r}}
    \toprule
    Parameters & Variant & $\#\mathsf{sk}$ & $\#\mathsf{sk}^{\eta}$ & $\#\mathsf{pk}$ & Difference \\ \midrule
    \multirow{3}{*}{Pc-080}  & \multirow{3}{\linewidth}{Pc-080 $(\mathbb{F}_{256}, 17, 13, 13)$}  & Classic  &  \multirow{3}{*}{  16757} &  \multirow{3}{*}{   4177} &    24596 &  $-30.42\%$ \\
                             &                                                    & Cyclic   &                           &                           &     9474 &  $-66.99\%$ \\
                             &                                                    & LRS2     &                           &                           &     8645 &  $-68.99\%$ \\
    \multirow{3}{*}{Pc-100}  & \multirow{3}{*}{$(\mathbb{F}_{256}, 26, 16, 17)$}  & Classic  &  \multirow{3}{*}{  41163} &  \multirow{3}{*}{   8364} &    58410 &  $-32.94\%$ \\
                             &                                                    & Cyclic   &                           &                           &    20266 &  $-71.25\%$ \\
                             &                                                    & LRS2     &                           &                           &    18682 &  $-72.84\%$ \\
    \multirow{3}{*}{Pc-128}  & \multirow{3}{*}{$(\mathbb{F}_{256}, 36, 21, 22)$}  & Classic  &  \multirow{3}{*}{  96288} &  \multirow{3}{*}{  17754} &   135880 &  $-33.83\%$ \\
                             &                                                    & Cyclic   &                           &                           &    44971 &  $-72.98\%$ \\
                             &                                                    & LRS2     &                           &                           &    42107 &  $-74.22\%$ \\
    \multirow{2}{*}{   I-a}  & \multirow{2}{*}{$(\mathbb{F}_{ 16}, 32, 32, 32)$}  & Classic  &  \multirow{2}{*}{  92928} &  \multirow{2}{*}{  26896} &   148992 &  $-27.29\%$ \\
                             &                                                    & nCyclic  &                           &                           &    58112 &  $-64.86\%$ \\
    \multirow{2}{*}{ III-c}  & \multirow{2}{*}{$(\mathbb{F}_{256}, 68, 36, 36)$}  & Classic  &  \multirow{2}{*}{ 511416} &  \multirow{2}{*}{  78188} &   710640 &  $-35.45\%$ \\
                             &                                                    & nCyclic  &                           &                           &   206712 &  $-76.69\%$ \\
    \multirow{2}{*}{   V-c}  & \multirow{2}{*}{$(\mathbb{F}_{256}, 92, 48, 48)$}  & Classic  &  \multirow{2}{*}{1227072} &  \multirow{2}{*}{ 180572} &  1705536 &  $-35.68\%$ \\
                             &                                                    & nCyclic  &                           &                           &   491904 &  $-77.07\%$ \\
    \bottomrule
  \end{tabular}
\end{table}

We compare key pair sizes when our method is used alongside Rainbow variants that reduce the public key size. Table~\ref{tab:2} presents results for sets of parameters from~\cite[Table 9.8]{Petzoldt:201307}. We calculate $\#\mathsf{pk}$ for the variants according to~\cite[Eq.~9.2,~9.4]{Petzoldt:201307}. As per~\cite[Remark 9.1]{Petzoldt:201307}, we note that $q = 16$ and $q = 31$ are not considered due to a security restriction of RainbowLRS2. We obtain positive results, with key pair size reductions of up to factors of 3.
