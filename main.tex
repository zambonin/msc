...
Multivariate cryptography is based on public-key cryptography, that is, the idea that an entity holds a key pair, composed of a private key and a public key, hereafter referred to as $\mathbf{sk}$ and $\mathbf{pk}$ respectively. This allows for several frameworks that ensure di properties.
