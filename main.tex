...
\begin{figure}[htbp]
  ...
  \begin{chronology}[startyear=2005, stopyear=2019, height=3pt, dates=false, arrow=false, align=center]
    ...
    \chronosp[markdepth=70pt]{12/2010}{Class~\ref{enum:i}~\cite{Petzoldt:201012:inproc}}
    \chronosp[markdepth=-20pt]{03/2011}{Class~\ref{enum:ii}~\cite{Petzoldt:201103:inproc}}
    \chronosp[markdepth=-100pt]{02/2012}{Class~\ref{enum:iii}~\cite{Yasuda:201202:inproc}}
    \chronosp[markdepth=-60pt]{09/2012}{Class~\ref{enum:iv}~\cite{Thomae:201209:inproc}}
    \chronosp[]{11/2012}{Class~\ref{enum:i}~\cite{Petzoldt:201211:inproc}}
    \chronosp[markdepth=-60pt]{02/2013}{Class~\ref{enum:iv}~\cite{Hashimoto:201302:inproc}}
    \chronosp[markdepth=50pt]{05/2013}{Class~\ref{enum:ii}~\cite{Yasuda:201305:inproc}}
    \chronosp[]{07/2013}{Class~\ref{enum:i}~\cite{Petzoldt:201307:phd}}
    \chronosp[]{04/2014}{Class~\ref{enum:ii}~\cite{Yasuda:201404:inproc}}
    \chronosp[markdepth=-20pt]{09/2014}{Class~\ref{enum:ii}~\cite{Yasuda:201409:article}}
    \chronosp[]{12/2015}{Class~\ref{enum:i}~\cite{Shim:201512:inproc}}
    \chronosp[markdepth=50pt]{06/2017}{Class~\ref{enum:i}~\cite{Beullens:201706:msc}}
    \chronosp[markdepth=-60pt]{06/2017}{Class~\ref{enum:iii}~\cite{Peng:201706:article}}
    \chronosp[]{06/2017}{Class~\ref{enum:i}~\cite{Szepieniec:201706:inproc}}
    \chronosp[markdepth=-20pt]{12/2017}{Class~\ref{enum:i}~\cite{Beullens:201712:inproc}}
