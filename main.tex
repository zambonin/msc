...
\end{align}
The size of a public key is the number of coefficients of $m$ polynomials in the ring $\mathcal{F}_{q}[x_{1}, \dots, x_{n}]$, which is known to be $\binom{n + d}{d}$. In the case of Oil--Vinegar polynomials, we have $d = 2$, and thus
\begin{align}
