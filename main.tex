...
% TODO expand
% -----8<-----
Consider the public key $\mathcal{P} = \mathcal{L}_{1} \circ \mathcal{C} \circ \mathcal{L}_{2}$ and let $\mathcal{Q} = \mathcal{C} \circ \mathcal{L}_{2}$. Since quadratic terms do not mix with linear and constant terms, we refer only to the quadratic part of any polynomial systems in our description. Hence, let 
