...
\begin{proposition}\label{prop:autgroup}
  Given a group $\mathsf{G}$, the set of all automorphisms $\mathsf{Aut}(\mathbf{G})$ carrying the usual function composition binary operation forms a group, denoted $\mathsf{Aut}(\mathsf{G})$.
\end{proposition}
