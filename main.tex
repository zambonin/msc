...
% TODO redo paragraphs on public key strategies (cyclic, theory)
...
We also classify the work in~\cite{} as relevant, since it is a general method motivated by the context of public key infrastructures, in which the size of a public key and signature bundle must be minimized. The method initially was proposed for multivariate trapdoors, and it was subsequently generalized~\cite{} to work in 
