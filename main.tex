...
There always exists at least one basis for a vector space~\cite{}. Indeed, it is a compact way of representing the entire set of vectors. For example, the \emph{identity matrix of order $n$} is a sequence of unit vectors over the base field
