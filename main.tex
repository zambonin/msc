...
However, we have to account for $\mathcal{L}_{2}$, since it is composed with $\mathcal{C}$ to form the public key. As argued in~\cite[p.~261]{Kipnis:199808}, the aforementioned behaviour is unchanged for any combination of polynomials of $\mathcal{P}$. Hence, a polynomial of the public key maps $\widetilde{\mathcal{O}}$ to $\widetilde{\mathcal{V}}$, and so forth. With several distinct combinations of such polynomials, it is possible to characterize the common invariant subspace $\widetilde{\mathcal{O}}$~\cite[Theorem~1]{Kipnis:199904}.
