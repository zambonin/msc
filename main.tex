...
A variant called LWRS~\cite{} drops the left affine transformation of the usual bipolar construction and applies a ``minus'' method~\cite[Subsection 3.2.1]{} to Rainbow in order to create a scheme suitable for performance-restricted devices. However, an extra layer is added to the scheme instance, and it is unclear if (i) the proposed modification is secure and (ii) suggested parameters are directly
