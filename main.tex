...
Consider the vector space $\mathbb{F}^{n}$ that denotes all possible signatures from a balanced Oil--Vinegar signature scheme, that is, $n = v + o$.

\begin{definition}
  The vector subspace that contains all vectors with the first coordinates equal to zero, that is, $\$
\end{definition}
