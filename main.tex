...
\begin{theorem}[{\cite[Theorem 2]{Beullens:201706}}]
  ...
  \begin{align}
    ...
    \begin{bmatrix}
      ...
      \mathcal{L}_{2}^{(3)} & \mathcal{L}_{2}^{(4)} -\mathcal{L}_{2}^{(3)} \cdot \mathsf{L}_{2}^{(-1, 2)} \\
    \end{bmatrix}
  \end{align}
  and $\mathcal{L}_{2}^{(1)} \in \mathsf{GL}_{v}(\mathbb{F})$, then
  \begin{align}
    \psi(\omega^{-1} \circ \mathcal{L}_{2}) = \begin{bmatrix}
      \mathbf{I}_{v} & \mathsf{L}_{2}^{(-1, 2)} \\
...
\begin{align}
  ...
  \end{bmatrix}
\end{align}
and obtain a reduction in the private key of a factor $\frac{n^{2}}{v o}$.
