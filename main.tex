...
Thus, the only remaining task is to build a basis $B$ of $\widetilde{\mathcal{O}}$, which has dimension $m$. The lower bound for the number of signatures collected such that combinations 
