...
\begin{definition}
  ...
  \begin{enumerate}
    ...
    \item The binary operation $\cdot$ left distributes over $\oplus$, that is, we must have that $f_{1} \cdot (\mathbf{v_{1}} \oplus \mathbf{v_{2}} = (f_{1} \cdot \mathbf{v_{1}}) \oplus (f_{1} \cdot \mathbf{v_{2}})$
  \end{enumerate}
\end{definition}
