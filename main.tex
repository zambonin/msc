...
\begin{enumerate}[label=(\roman*), itemsep=1pt]
    \item Maintenance of a bibliography featuring works related to key reductions in Rainbow-like signature schemes.
    \item Classification of the strategies used by scheme variants to reduce private or public keys.
    \item Development of a key modification strategy that is independent from existing ones.
    \item Test the new variant against known cryptanalytic methods, particularly ones that take advantage of the new concepts behind the scheme.
