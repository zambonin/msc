...
% TODO use homogeneous quadratic + linear maps on first table, comment on that
% TODO add new rainbow parameters for cyclic (nist 2nd round) on second table
% TODO review text
...
% TODO argument of Petzoldt from PQCrypto 2020 in that it's efficient
