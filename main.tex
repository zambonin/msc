...
% TODO redo paragraphs on public key strategies (cyclic, bac, theory)
...
A development by the name of block-anti-circulant (BAC) UOV~\cite{} forces that the matrices representing the central map and public key are
