...
A revisão bibliográfica realizada demonstra que a modificação do esquema Rainbow a fim de obter reduções nos tamanhos de suas chaves frequentemente facilita a aplicação de métodos algébricos que reduzem a segurança do esquema resultante. 
