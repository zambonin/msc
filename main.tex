...
The number of signatures needed to attack our proposal can be improved. We implement a naive strategy that always yields symbolically linearly independent vectors, but it may be the case that carefully picked combinations of a smaller number of signatures

Finally, further work is needed on the security of Rainbow signature schemes with partially fixed vinegar variables. 
