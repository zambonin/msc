...
For instance, the prime field $\mathbb{F}_{q}$ is composed of the set $\{0, \dots, q - 1\}$ equipped with usual addition modulo $q$ and multiplication modulo $q$. The respective inverse operations are subtraction modulo $q$ and  Examples of algebraic
In order to construct more elaborate structures on top of prime fields, it is useful to define 
