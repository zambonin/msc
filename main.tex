...
What occurs in the experiment is that the adversary, given a public key, can obtain signatures from at most $q$ messages. These messages may be chosen adaptively, that is, a new query may depend on replies to previous ones.
