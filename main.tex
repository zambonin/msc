...
If the vector subspace $\widetilde{\mathcal{O}}$ is known, it is also possible to obtain its basis $B$ of dimension $o$. Consider $\phi(\widetilde{\mathcal{L}}_{2})$ as the $n \times n$ invertible matrix with the elements of $B$ in its last $o$ rows.
