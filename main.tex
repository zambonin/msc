...
Families of multivariate public key cryptosystems are distinct 
Particularly interesting are signature schemes based on the Oil--Vinegar principle, of which Rainbow receives primary attention. 
