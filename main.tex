...
\begin{definition}
  Given a ring $(R, +, \times)$ and any $r_{1} \in R, r_{1} \neq e$, if there exists a unique element $f \in R$ such that $r_{1} \times f = f \times r_{1} = r_{1}$, then the ring is called a \emph{unit ring}.
\end{definition}

\begin{definition}
  Given a unit ring $(R, +, \times)$ and any $r_{1} \in R, r_{1} \neq e$, if there exists a uniquely
\end{definition}

We hereafter refer to $0$ as the \emph{additive identity} and to $1$ as the \emph{multiplicative identity} of a ring. Analogously, given a ring $(R, +, \times)$ and for any $r_{1} \in R$, we denote $-r_{1}$ as the \emph{additive inverse of $r_{1}$}, and $r_{1}^{-1}$ as the \emph{multiplicative inverse of $r_{1}$}.
