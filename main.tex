...
Finally, for the sake of completeness, we give definitions of a cryptographic hash function, which is the usual method of transforming a variable-length message into a fixed-length digest, 
