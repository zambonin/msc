...
The definition above amounts to ordering monomials according to their associated $n$-uples of exponents, which is more intuitive. Lexicographic ordering compares the exponents of $x_{1}$ and only if they are equal it compares exponents of $x_{2}$. 
