...
In this thesis, we solely discuss multivariate signature schemes based on the Oil--Vinegar principle. More precisely, UOV~\cite{} and its generalization Rainbow~\cite{Ding:200506} receives primary attention. It performs computations over a single field and presents a balanced nature and simple, elegant definitions. As such, schemes of a different structure such as HFE~\cite{}, or multivariate public-key encryption schemes such as~\cite{}, are not addressed. Furthermore, we specifically discuss strategies for reducing key sizes of Rainbow-like signature schemes and the security implications of such methods.
