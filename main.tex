...
\begin{align}
    \begin{cases}
        \sum_{i = 1}^{n} \sum_{j = i}^{n} \alpha_{ij}^{(1)} x_{i} x_{j} + \sum_{i = 1}^{n} \beta_{i}^{(1)} x_{i} + \gamma_{0}^{(1)} \\
        \vdots \\
        \sum_{i = 1}^{n} \sum_{j = i}^{n} \alpha_{ij}^{(m)} x_{i} x_{j} + \sum_{i = 1}^{n} \beta_{i}^{(m)} x_{i} + \gamma_{0}^{(m)},
    \end{cases} \alpha, \beta, \gamma \in \mathbb{F}.
\end{align}
