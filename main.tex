...
\begin{theorem}[{\cite[Theorem 4.17]{Wolf:201104}}]
  Given a private key $(\mathcal{L}_{1}, \mathcal{C}, \mathcal{L}_{2}) \in \mathsf{GL}(\mathbb{F}^{m}) \times \mathsf{RB}(v_{1}, o_{1}, \dots, o_{u}) \times \mathsf{GL}(\mathbb{F}^{m}), \; \tau \in  \mathsf{GL}(\mathbb{F}^{m}), \; \omega \in  \mathsf{GL}(\mathbb{F}^{n})$ with matrix representations of the form
  \begin{align}
