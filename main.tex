...
The bipolar construction creates a specific situation in which the schemes derived from it are not exclusively based on the polynomial system solving problem. Instead, it is proven that there exist many private keys that construct a single public key.
