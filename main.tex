...
\end{align}
By fixing a specific $\mathcal{L}_{2}$, Equation~\ref{} becomes a linear relation between the coefficients of the private and public keys. This allows for the reconstruction of $\mathcal{C}$ from $\mathcal{P}$ and $\mathcal{L}_{2}$. The process for Rainbow is analogous, with a small difference due to the existence of two lateral maps. Since $\mathcal{L}_{2}$ simply permutes coefficients maintaining the structure of $\mathcal{C}$, we let $\mathcal{Q} = \mathcal{C} \circ \mathcal{L}_{2}$, and consequently $\mathcal{P} = \mathcal{L}_{1} \circ \mathcal{Q}$.
