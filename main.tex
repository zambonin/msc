...
As a generalization of UOV, Rainbow also has equivalent keys by a similar rationale. The theory is developed in~\cite[Section 4.4]{Wolf:201104} for STS, which is a special sparse case of Rainbow. It is argued in~\cite{Petzoldt:201307} that it also works for Rainbow.
