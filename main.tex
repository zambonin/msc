...
\begin{align}
  \#\mathbf{sk} = \underbrace{m^{2} + m}_{\mathcal{S}} 
...
\begin{table}[htbp]
  ...
  \begin{tabular}{*{2}{l}*{5}{r}}
    \toprule
    Instance & Parameters & $n$ & $m$ & $\#\mathbf{sk}$ & $|\mathcal{K}_{Pr} ^{\eta}|$ & Difference \\ \midrule
...
\begin{table}[htbp]
  ...
  \begin{tabular}{*{2}{l}*{5}{r}}
    \toprule
    Instance & Parameters & Variant & $\#\mathbf{sk}$ & $|\mathcal{K}_{Pr} ^{\eta}|$ & $|\mathcal{K}_{Pu}|$ & Difference \\ \midrule
...
We compare the total key pair sizes $\#\mathbf{sk} + |\mathcal{K}_{Pu}|$
