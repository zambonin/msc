...
The linear transformations $\tau^{-1}$ and $\omega^{-1}$ maintain their forms, that is,
\begin{align}
  \begin{split}
    \psi(\tau^{-1}) &=
    \begin{bmatrix}
    ...
    \begin{bmatrix}
      ...
      -(\omega^{(3)})^{-1} \omega^{(2)} \cdot (\omega^{(1)})^{-1} & (\omega^{(3)})^{-1} & \mathbf{0}_{o_{1} \times o_{2}} \\
      -(-(\omega^{(6)})^{-1} \cdot \omega^{(5)} \cdot (\omega^{(3)})^{-1}) \cdot \omega^{(4)} \cdot -(\omega^{(3)})^{-1} \omega^{(2)} \cdot (\omega^{(1)})^{-1} & -(\omega^{(6)})^{-1} \cdot \omega^{(5)} \cdot (\omega^{(3)})^{-1} & (\omega^{(6)})^{-1} \\
    \end{bmatrix}.
  \end{split}
\end{align}

The redundancy is removed by a similar rationale, observing the shape of the lateral maps in the equivalent key.
