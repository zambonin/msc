...
Despite its simple construction that allows for several modifications, the Rainbow signature scheme is also very prone to the introduction of subtle weaknesses. Our efforts show that even deviating from the common structural changes to the private key still leads to an insecure scheme. Thus, we restate the importance of carefully observing the consequences of modifying a cryptographic system. Nonetheless, we attempted to provide a comprehensive 
