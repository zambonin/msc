...
\end{align}
Let us define $\chi_{i} = \sigma_{i} - \sigma_{j}$. By Definition~\ref{def:oil-subspace}, $\chi_{i} \in \widetilde{\mathcal{O}}$. This is an effective characterization of the desired subspace in the UOV attack. To build a basis of this set, $m$ linearly independent $\chi_{i}$ must be collected. Let us call this set $\widetilde{\rho}$. We note that at least $m + 1$ signatures need to be collected to perform $m$ subtractions.
