...
It is thus expected that a large enough number of signatures is collected for a reasonable chance of obtaining a valid sample. For example, given $N = 2^{16}$ and $K = 2^{14}$, or $\alpha = 0.25$, and a target of $m = 64 + 1$ signatures, the mode of the associated PMF would give 
