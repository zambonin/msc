...
approach is similar to~\cite{Shim:201512}, but it is not as costly, since the
...
supplied. We denote this variant as Rainbow-$\eta_{1}$.
...
$(\mathbf{S}, \widetilde{V}_{1}, \mathcal{L}_{1}, \overline{\mathcal{C}}, \mathcal{L}_{2})$ and the public key is
$\mathcal{P}$.
