...
The security analysis performed to assert the safety of using our proposal was performed considering that there were no changes in parameters, thus maintaining the complexity of known attacks.
