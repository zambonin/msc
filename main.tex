...
A vibrant discipline of cryptography, signature schemes are often associated with digital systems, in which transit of sensitive messages is expected to be secure. However, a specific scheme used within this situation drastically alters matters of security and performance, due to its performance. Signature schemes are naturally bound to hard computational problems, due to their dependence on public-key cryptography. Thus, it is expected that advances in computer engineering present direct consequences on the development of signature schemes.
