...
changes in the probability with the growth of $m$. We note that this is closely related to the pentagonal number theorem due to Euler~\cite{}. Thus, we can make use of the identity below, proved in~\cite{}, 
\begin{align}
