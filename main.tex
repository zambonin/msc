...
We give a short introduction to cryptosystems which are based on systems of multivariate equations. Polynomials used within this context have $n$ variables, that is, $\mathbf{x} = (x_{1}, \dots, x_{n})$, and their coefficients are elements of a finite field $\mathbb{F}$. Thus, operations are described by the polynomial ring $\mathbb{F}[\mathbf{x}]$.
