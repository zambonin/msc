...
\begin{theorem}[{\cite[Theorem 3.6]{Petzoldt:201307}}]
  ...
  \begin{enumerate}
    ...
    \begin{align}
      ...
      \end{bmatrix}.
    \end{align}
    \item Let $\mathsf{L}_{12}'$ Given $\omega \in \mathsf{GL}(\mathbb{F}^{n})$ such that
    \begin{align}
      \begin{split}
        \psi(\omega) =
        \begin{bmatrix}
          \mathcal{L}_{2}^{(1)} & \mathbf{0}_{v_{1} \times o_{1}} & \mathbf{0}_{v_{1} \times o_{2}} \\
          \mathcal{L}_{2}^{(4)} & \mathcal{L}_{2}^{(5)} - \mathcal{L}_{2}^{(4)} \cdot (\mathcal{L}_{2}^{(1)})^{-1} \cdot \mathcal{L}_{2}^{(2)} & \mathbf{0}_{o_{1} \times o_{2}} \\
          \mathcal{L}_{2}^{(7)} & \mathcal{L}_{2}^{(8)} - \mathcal{L}_{2}^{(7)} \cdot (\mathcal{L}_{2}^{(1)})^{-1} \cdot \mathcal{L}_{2}^{(2)} & \omega^{(6)} \\
        \end{bmatrix}, \\
        \begin{multlined}[t]
          \omega^{(6)} = \mathcal{L}_{2}^{(9)} - \mathcal{L}_{2}^{(7)} \cdot (\mathcal{L}_{2}^{(1)})^{-1} \cdot \mathcal{L}_{2}^{(3)} - \omega^{(5)} \\ \cdot (\omega^{3})^{-1} \cdot \mathcal{L}_{2}^{(6)} - \mathcal{L}_{2}^{(4)} \cdot (\mathcal{L}_{2}^{(1)})^{-1} \cdot \mathcal{L}_{2}^{(3)}
        \end{multlined}
      \end{split}
    \end{align}
    ...
    \begin{align}
      ...
      \begin{bmatrix}
        \mathbf{I}_{v_{1}} & (\mathcal{L}_{2}^{(1)})^{-1} \cdot \mathcal{L}_{2}^{(2)} & (\mathcal{L}_{2}^{(1)})^{-1} \cdot \mathcal{L}_{2}^{(3)} \\
        \mathbf{0}_{o_{1} \times v_{1}} & \mathbf{I}_{o_{1}} & (\omega^{(3)})^{-1} \cdot \mathcal{L}_{2}^{(6)} - \mathcal{L}_{2}^{(4)} \cdot (\mathcal{L}_{2}^{(1)})^{-1} \cdot \mathcal{L}_{2}^{(3)} \\
