...
\begin{theorem}[{\cite[Theorem 2]{Beullens:201706}}]
  Given a private key $(\mathcal{C}, \mathcal{L}_{2}) \in \mathsf{OV}(v, o) \times \mathsf{GL}(\mathbb{F}^{n})$ and $\omega \in \mathsf{GL}(\mathbb{F}^{n})$. If matrix representations of the linear transformations are of the form
  \begin{align}
    \mathcal{L}_{2} = 
    \begin{bmatrix}
...
Analogously to the case of UOV, 
