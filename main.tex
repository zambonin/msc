    ...
    \begin{align}
      \begin{split}
        ...
        \begin{bmatrix}
          ...
          \mathcal{L}_{2}^{(4)} &  & \mathbf{0}_{o_{1} \times o_{2}} \\
          \mathcal{L}_{2}^{(7)} & \mathcal{L}_{2}^{(8 - 7 \cdot 1^{-1} \cdot 2)} & \omega^{(6)} \\
        \end{bmatrix}, \\
        &\begin{multlined}[t]
          \omega^{(3)} = \mathcal{L}_{2}^{(5 - 4 \cdot 1^{-1} \cdot 2)}
          \end{multlined}
        &\begin{multlined}[t]
          \omega^{(6)} = \mathcal{L}_{2}^{((9 - 7 \cdot 1^{-1} \cdot 3) -(8 - 7 \cdot 1^{-1} \cdot 2) \cdot (5 - 4 \cdot 1^{-1} \cdot 2)^{-1} \cdot (6 - 4 \cdot 1^{-1} \cdot 3))}
        \end{multlined}
      \end{split}
    \end{align}
