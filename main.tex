...
In this chapter, we introduce the mathematical toolbox necessary in order to fully comprehend the remainder of this work. In Section~\ref{}, we define basic algebraic structures that rule the operations of mathematical structures within our scope. In Section~\ref{}, we introduce the general bipolar construction of multivariate cryptography and properly define a multivariate signature scheme, with a discussion of its underlying problems. In Section~\ref{}, we discuss the Unbalanced Oil and Vinegar signature scheme, its generalized form Rainbow, and how this trapdoor is impacted by cryptanalytic methods.
...
\subsection{Bipolar construction}
