...
Despite its simple construction that allows for several modifications, the Rainbow signature scheme is also very prone to the introduction of subtle weaknesses. Our efforts show that even deviating from the common structural changes to the private key still leads to an insecure scheme. Thus, we restate the importance of carefully observing the consequences of modifying a cryptographic system. Further, with our adjustment to the proposed scheme, we aim to provide a useful modification that can address the main problem in multivariate cryptography.

\subsubsection{Future work.}

We have identified a number of potential and interesting topics to extend our research. 
