...
We give a short introduction to cryptosystems which are based on systems of multivariate equations. Recall that a polynomial is a mathematical expression that consists of coefficients and indeterminates (or variables). Only addition, subtraction, multiplication and integer exponentiation operations are permitted within these expressions.
