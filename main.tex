...
O objetivo principal deste trabalho é a discussão de estratégias para redução de chaves em esquemas de assinatura digital baseados em polinômios multivariados. Mais precisamente, são discutidas consequências de tais estratégias em relação à segurança dos esquemas propostos, levando em conta métodos de criptanálise algébrica existentes na literatura. Neste contexto, a possibilidade de uma estratégia original para redução de chaves é debatida, e 
