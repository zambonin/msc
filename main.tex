...
In other words, the leading zeros in any vector of $\mathcal{O}$ are preserved by the mapping of a linear combination of polynomials in $\mathcal{C}$. This is carried on by any $\widetilde{M}(f^{(i)})$ with $f^{(i)}$ a polynomial of $\mathcal{P}$.
