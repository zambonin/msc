...
We note that in the case of STS and TTS, reducing the private key was not the main intention of the authors, and it is thus not trivial to estimate such gains through direct comparison to Rainbow. On the other hand, with the general description of the scheme available, there have been several works which focus on modifying Rainbow with the purpose of reducing key sizes. This may be partially due to recent research efforts towards quantum-safe cryptography
