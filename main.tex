...
% Particularly interesting are signature schemes based on the Oil--Vinegar principle, of which Rainbow~\cite{Ding:200506} receives primary attention. It performs computations over a single field and presents a balanced nature and simple, elegant definitions.
