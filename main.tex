...
by the Q-Q plot, which in this case is more commonly referred to as a normal probability plot. It is built by pairing the normalized counts with quantiles from the standard normal distribution. Such quantiles are chosen to be approximate normal order statistics, or rankits~\cite{}, which are hereafter referred to as $K$ and generated as follows. 
