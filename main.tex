...
Hence, we note that the inversion event happens almost certainly. Moreover, this evidence shows that computing a preimage to sign a message happens at the first try with high probability in a wide range of Rainbow configurations. Hence, the cost of generating a signature with Rainbow-$\eta$ does not significantly increase due to an occasional central map reconfiguration is amortized by the overwhelming probability that a signature is successfully generated.
