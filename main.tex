...
In Section~\ref{sec:eta}, we give a formal description of our modifications, alongside with a security analysis taking into account current cryptanalytic methods for Rainbow. In Section~\ref{sec:stats}, we argue that no change of parameters are needed to maintain performance and randomness of creating signatures. 
...
method. In Section~\ref{sec:experiments}, we measure how our modifications behave when applied to current sets of parameters for Rainbow-like schemes.
