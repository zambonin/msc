...
by the Q-Q plot created by pairing the normalized counts with sampled values from a standard normal distribution, where the points are sufficiently close
