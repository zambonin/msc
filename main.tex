...
Families of multivariate public key cryptosystems are defined according to the types of finite fields used in the computations. Particularly interesting are signature schemes based on the Oil--Vinegar principle, that only use a single field. of which Rainbow receives primary attention. 
