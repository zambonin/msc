...
We now turn to the most commonly used framework in multivariate cryptography employed to build cryptosystems. The \emph{bipolar construction}, due to its elegant twofold nature, yields the possibility of building public-key encryption or signature schemes with the same idea. 
