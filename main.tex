...
Handwritten signatures are one of the ubiquitous ways to ensure trust, in the case that a contract is sealed between parties. However, they present various logistical and security shortcomings. For instance, individuals need to be physically present to sign any documents, and the possibility of calligraphy forgery by malicious parties.
