...
We note that in the case of STS and TTS, reducing the private key did not appear to be the main intention of the authors, and it is thus not trivial to estimate such gains through direct comparison to Rainbow. On the other hand, several newer proposals are directly focused on the reduction of keys 
