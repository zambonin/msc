...
In this chapter, we describe the research strategy applied to produce this work. We define the main research question, parse the related body of literature, and finally apply several reproducible methods in order to infer conclusions. Indeed, this is essentially a description of the usual scientific method. In other words, we infer knowledge from mensurable experiments of deductions, in order to solve specific problems that come with the hypothesis.
