...
% Consider a finite field $\mathbb{F}$ and $v, o \in \mathbb{N}$.  Let $V = \{1, \dots, v\}$ and $O = \{v + 1, \dots, v + o\}$. The total number of variables is $n = v + o$, and thus  \in \mathbb{F}^{n}$.
...
\begin{align}\label{eq:ov}
  \begin{split}
    \sum_{i \in V_{l}} \sum_{j \in V_{l}} \alpha_{ij} x_{i} x_{j}
