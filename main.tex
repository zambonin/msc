...
\begin{theorem}[{\cite[Theorem 3.6]{Petzoldt:201307}}]
  ...
  \begin{enumerate}
    ...
    \begin{align}
      \psi(\omega) =
      \begin{bmatrix}
        \mathcal{L}_{1}^{(1)} & \mathbf{0}_{v_{1} \times o_{1}} & \mathbf{0}_{v_{1} \times o_{2}} \\
        \mathcal{L}_{1}^{(4)} & \mathcal{L}_{2}^{(5)} & \mathcal{L}_{2}^{(6)} \\
        \mathcal{L}_{1}^{(7)} & \mathcal{L}_{2}^{(8)} & \mathcal{L}_{2}^{(9)} \\
      \end{bmatrix}
    \end{align}
