...
Consider a finite field $\mathbb{F}_{q}$ and $v, o \in \mathbb{N}$. These integers represent the quantity of vinegar and oil variables, respectively. We then have $\mathbf{x} = (x_{1}, \dots, x_{v}, x'_{1}, \dots, x'_{o})$. The total number of variables is $n = v + o$.
