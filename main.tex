...
\begin{figure}[htbp]
  ...
  \begin{chronology}[startyear=2005, stopyear=2019, height=3pt, dates=false, arrow=false, align=center]
    ...
    \chronosp[markdepth=-20pt]{06/2005}{\cite{Ding:200506:inproc}~\ref{enum:ii}}
    \chronosp[markdepth=-60pt]{04/2006}{\cite{Yang:200604:inproc}~\ref{enum:iii}}
    \chronosp[]{09/2006}{\cite{Billet:200609:inproc}~\ref{enum:iv}}
    \chronosp[]{06/2008}{\cite{Ding:200806:inproc}~\ref{enum:iv}}
    \chronosp[markdepth=-60pt]{06/2010}{\cite{Petzoldt:201006:inproc}~\ref{enum:ii}}
    \chronosp[]{12/2010}{\cite{Petzoldt:201012:inproc}~\ref{enum:i}}
    \chronosp[markdepth=-20pt]{03/2011}{\cite{Petzoldt:201103:inproc}~\ref{enum:ii}}
    \chronosp[markdepth=-100pt]{02/2012}{\cite{Yasuda:201202:inproc}~\ref{enum:iii}}
    \chronosp[markdepth=-60pt]{09/2012}{\cite{Thomae:201209:inproc}~\ref{enum:iv}}
    \chronosp[]{11/2012}{\cite{Petzoldt:201211:inproc}~\ref{enum:i}}
    \chronosp[markdepth=-20pt]{02/2013}{\cite{Hashimoto:201302:inproc}~\ref{enum:iv}}
    \chronosp[markdepth=50pt]{05/2013}{\cite{Yasuda:201305:inproc}~\ref{enum:ii}}
    \chronosp[markdepth=-100pt]{07/2013}{\cite{Petzoldt:201307:phd}~\ref{enum:i}}
    \chronosp[]{04/2014}{\cite{Yasuda:201404:inproc}~\ref{enum:ii}}
    \chronosp[markdepth=-20pt]{09/2014}{\cite{Yasuda:201409:article}~\ref{enum:ii}}
    \chronosp[]{12/2015}{\cite{Shim:201512:inproc}~\ref{enum:i}}
    ...
    \chronosp[]{06/2017}{\cite{Szepieniec:201706:inproc}~\ref{enum:i}}
    \chronosp[markdepth=-20pt]{12/2017}{\cite{Beullens:201712:inproc}~\ref{enum:i}}
    \chronosp[markdepth=-20pt]{10/2018}{\cite{Hashimoto:201810:misc}~\ref{enum:iv}}
  \end{chronology}
