...
\begin{theorem}[{\cite[Theorem 4.17]{Wolf:201104}}]
  ...
  \begin{align}
    \begin{bmatrix}
      ...
      \tau_{o_{2} \times o_{2}}^{(2)} & \tau_{o \times o}^{(3)} \\
    \end{bmatrix},
  \end{align}
  and $...$, then $(\mathcal{L}_{1} \circ \tau^{-1}, \tau \circ \mathcal{C} \circ \omega, \omega^{-1} \circ \mathcal{L}_{2}$ is an equivalent private key.
\end{theorem}
