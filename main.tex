...
\begin{definition}
  Given a function $\mathcal{H} : X \to Y$ and any $x \in X$, $\mathcal{H}$ is a \emph{hash function} if calculating $\mathcal{H}(x)$ is deterministic and computationally easy.
\end{definition}
