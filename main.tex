...
\end{align}
By fixing a specific $\mathcal{L}_{2}$, Equation~\ref{} becomes a linear relation between the coefficients of the private and public keys. This allows for the reconstruction of $\mathcal{C}$ from $\mathcal{P}$ and $\mathcal{L}_{2}$. % what about the linear part
