...
In this chapter, we will present the theory needed to understand Rainbow as a signature scheme. Section~\ref{sec:crypto} presents basic definitions to cryptographic jargon, as well as a sketch of the discipline known as multivariate cryptography. Section~\ref{sec:oil} des
