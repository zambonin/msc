...
\begin{figure}[htbp]
    \begin{chronology}[startyear=2005, stopyear=2013, height=3pt, dates=false, arrow=false, align=center]
        \definechronoevent{sp}[textstyle=\footnotesize, 
      datesseparation=/, conversionmonth=false]
\chronosp[colorbox=yellow!10,markdepth=-20pt]{06/2005}{\cite{Ding:200506:inproc}}
...
\chronosp[colorbox=green!10]{11/2012}{PB~\cite{Petzoldt:inproc:2012:nov}}
  \end{chronology}
% \startchronology[startyear=2013,stopyear=2019,startdate=false,stopdate=false,arrow=false,height=3pt]
% \chronoevent[colorbox=blue!10,markdepth=-60pt]{2/2013}{Has~\cite{Hashimoto:inproc:2013:feb}}
% \chronoevent[colorbox=yellow!10,markdepth=50pt]{5/2013}{YDTS~\cite{Yasuda:inproc:2013:may}}
% \chronoevent[colorbox=green!10,markdepth=-20pt]{6/2013}{PBB~\cite{Petzoldt:inproc:2013:jun}}
% \chronoevent[colorbox=green!10]{7/2013}{Pet~\cite{Petzoldt:phd:2013:jul}}
% \chronoevent[colorbox=green!10,markdepth=-60pt]{1/2014}{YTS~\cite{Yasuda:article:2014:jan}}
% \chronoevent[colorbox=yellow!10]{4/2014}{YTS~\cite{Yasuda:inproc:2014:apr}}
% \chronoevent[colorbox=yellow!10,markdepth=-20pt]{9/2014}{YTS~\cite{Yasuda:article:2014:sep}}
% \chronoevent[colorbox=green!10]{12/2015}{SPB~\cite{Shim:inproc:2015:dec}}
% \chronoevent[colorbox=green!10,markdepth=50pt]{6/2017}{Beu~\cite{Beullens:msc:2017:jun}}
% \chronoevent[colorbox=red!10,markdepth=-60pt]{6/2017}{PT~\cite{Peng:article:2017:jun}}
% \chronoevent[colorbox=green!10]{6/2017}{SBP~\cite{Szepieniec:inproc:2017:jun}}
% \chronoevent[colorbox=green!10,markdepth=-20pt]{12/2017}{BP~\cite{Beullens:inproc:2017:dec}}
% \chronoevent[colorbox=red!10,markdepth=50pt]{03/2018}{PT~\cite{Peng:article:2018:mar}}
% \chronoevent[colorbox=blue!10,markdepth=-20pt]{10/2018}{Has~\cite{Hashimoto:misc:2018:oct}}
% \stopchronology
