...
\end{align}.
The size of a public key is the summation of the number of elements in the matrices associated with the homogeneous quadratic forms, as per Equation~\ref{}, of all polynomials in the system, or
\begin{align}
