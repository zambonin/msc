...
However, we have to account for $\mathcal{L}_{2}$, since it is composed with $\mathcal{C}$ to form the public key. As argued in~\cite[p.~261]{Kipnis:199808}, the aforementioned behaviour is unchanged for any combination of polynomials of $\mathcal{P}$. Analogously, a polynomial of the public key maps $\widetilde{\mathcal{O}}$ to $\widetilde{\mathcal{}}$

Thus, it suffices to find the vector space $\widetilde{\mathcal{O}}$ as a common invariant subspace of all linear transformations represented by combinations of polynomials of the public key~\cite[Theorem~1]{Kipnis:199904}.
