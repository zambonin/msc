...
\begin{align}
  \mathbf{pk} &= \mathcal{P} \in \mathsf{MQ}(n, m).
\end{align}
For $u = 2$, the matrix representation of a homogeneous quadratic $\mathcal{C}$ is equivalent to
\begin{align}
  \widetilde{M}(p^{(i)}) =
  \begin{cases}
    \begin{bmatrix}
    ...
    \end{bmatrix} \text{for } 1 \leq i \leq o_{1}, \\
    \begin{bmatrix}
    ...
    \end{bmatrix} \text{for } o_{1} + 1 \leq i \leq o_{2}.
  \end{cases}
\end{align}
