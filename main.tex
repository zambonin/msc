...
A vibrant discipline of public-key cryptography, signature schemes are often associated with digital systems, in which transit of sensitive messages is again expected to be secure. The initial public discovery of digital signature schemes is given in~\cite{rsa}, which is still widely used at the time of the writing. It is based on the difficulty of integer factorization, which is known to be computationally hard to solve with classical computers. Other popular schemes, such as~\cite{}, are based in some instance of the discrete logarithm problem.
...
%      define hypothesis, objectives and scope before searching the literature (outline and contributions too)
