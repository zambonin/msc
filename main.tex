...
With most mathematical machinery defined, we now introduce the building blocks to create a generic public-key cryptosystem based on multivariate polynomial equations, with particular focus on digital signature schemes. We recall that public keys in multivariate cryptography are polynomial systems. We start by introducing which polynomials are chosen in this context and how they interact to hide secret information and create a cryptosystem.
