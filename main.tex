...
by the Q-Q plot, which in this case is more commonly referred to as a normal probability plot. Given a number $r$ of $q$-uple samples from a standard normal distribution, a $q$-uple of approximate normal order statistics is calculated by taking the mean of every $k$-th smallest value 
