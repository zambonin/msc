...
\begin{figure}[htbp]
  ...
  \begin{chronology}[startyear=2005, stopyear=2019, height=3pt, dates=false, arrow=false, align=center]
    ...
    \chronosp[markdepth=-60pt]{02/2012}{\cite{Yasuda:201202:inproc}~\ref{enum:iii}}
    \chronosp[markdepth=-20pt]{09/2012}{\cite{Thomae:201209:inproc}~\ref{enum:iv}}
    \chronosp[markdepth=50pt]{11/2012}{\cite{Petzoldt:201211:inproc}~\ref{enum:i}}
    \chronosp[markdepth=-100pt]{02/2013}{\cite{Hashimoto:201302:inproc}~\ref{enum:iv}}
    \chronosp[]{05/2013}{\cite{Yasuda:201305:inproc}~\ref{enum:ii}}
    \chronosp[markdepth=-60pt]{07/2013}{\cite{Petzoldt:201307:phd}~\ref{enum:i}}
    ...
    \chronosp[]{10/2018}{\cite{Hashimoto:201810:misc}~\ref{enum:iv}}
  \end{chronology}
