...
\begin{align}
  ...
  \end{split}
\end{align}
or roughly three in ten thousand private keys which are effective targets for attacking, due to a $\mathbf{v}$ with high Hamming weight. For parameters with higher security targets, such as $q = 256$ and $v_{1}$ 
