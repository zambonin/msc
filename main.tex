...
The main observation of the attack is given in~\cite[Lemma~4]{Kipnis:199808}. It states that the matrices associated with each polynomial system of $\mathcal{C}$ are specifically structured. This is shown in Definition~\ref{def:ovh-matrix}, and this fact carries over to the public key for some combinations of $v$ and $o$.
