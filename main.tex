...
\begin{align}
  ...
  \end{split}
\end{align}
This description is tailored for schemes that perform calculations over a single finite field, as is the case of the Oil--Vinegar family. However, the bipolar construction can be extended to work differently 
