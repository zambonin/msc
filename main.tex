\documentclass[openright, landscape]{report}
\usepackage[utf8]{inputenc}
\usepackage{chronosys, enumitem, booktabs}
...
\begin{figure}[htbp]
  ...
  \begin{chronology}[startyear=2005, stopyear=2019, height=3pt, dates=false, arrow=false, align=center]
    ...
    \chronosp[markdepth=-60pt]{04/2006}{\cite{Yang:200604:inproc}~\ref{enum:iii}}
    ...
    \chronosp[markdepth=-60pt]{06/2010}{\cite{Petzoldt:201006:inproc}~\ref{enum:ii}}
    ...
    \chronosp[markdepth=90pt]{02/2012}{\cite{Yasuda:201202:inproc}~\ref{enum:iii}}
    \chronosp[markdepth=-100pt]{09/2012}{\cite{Thomae:201209:inproc}~\ref{enum:iv}}
    \chronosp[markdepth=50pt]{11/2012}{\cite{Petzoldt:201211:inproc}~\ref{enum:i}}
    \chronosp[markdepth=-60pt]{02/2013}{\cite{Hashimoto:201302:inproc}~\ref{enum:iv}}
    ...
    \chronosp[markdepth=50pt]{04/2014}{\cite{Yasuda:201404:inproc}~\ref{enum:ii}}
    \chronosp[markdepth=-60pt]{09/2014}{\cite{Yasuda:201409:article}~\ref{enum:ii}}
    \chronosp[markdepth=5pt]{12/2015}{\cite{Shim:201512:inproc}~\ref{enum:i}}
    \chronosp[markdepth=50pt]{06/2017}{\cite{Beullens:201706:msc}~\ref{enum:i}}
    \chronosp[markdepth=-60pt]{06/2017}{\cite{Peng:201706:article}~\ref{enum:iii}}
