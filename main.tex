...
Consider $m > n$. The function $\mathcal{M}$ should be injective, to assure that there exists a plaintext related to each ciphertext in the preimage process. Indeed, there are encryption schemes in which a non-negligible probability of failure exists.
