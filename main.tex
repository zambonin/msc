...
failure occurs in the central map inversion algorithm, we invoke the key generation step through $\mathbf{S}$ to
obtain $\mathcal{C}$, choose other values for $\widetilde{V}_{1}$ and
