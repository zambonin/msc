...
We now turn to a brief security analysis of our proposal, taking into account known algebraic cryptanalysis and the attack of Subsection~\ref{subsec:etaks}. Once again, we do not discard the possibility that a method to make use of any possible leaked information in signatures exists, independent of the number of fixed vinegar variables. However, 
