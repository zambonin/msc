...
The definition above amounts to ordering monomials according to their associated $n$-uples of exponents, which is more intuitive. We further discuss strategies for ordering in Section~\ref{sec:mult}.
