...
The general form of such a polynomial system is

\begin{align}
  \begin{split}
    \begin{cases}
      p_{1}(x_{1}, \dots, x_{n}) =& \sum_{i = 1}^{n} \sum_{j = i}^{n} \alpha_{ij} x_{i} x_{j}
        + \sum_{i = 1}^{n} \beta_{i} x_{i} + \gamma, \\
    \end{cases} \\
    x_{i}, x_{j}, \alpha_{ij}, \beta_{i}, \gamma \in \mathbb{F}_{q}.
  \end{split}
\end{align}
