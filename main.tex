...
Thus, the only remaining task is to build a basis $B$ of $\widetilde{\mathcal{O}}$, which has dimension $m$. Therefore, we need at least $m + 1$ signatures to perform $m$ subtractions and obtain $\widetilde{\rho} = \{ \chi_{1}, \dots, $
