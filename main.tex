...
\usepackage{chronosys, enumitem, rotating}
...
\begin{sidewaysfigure}[htbp]
  \begin{chronology}[startyear=2005, stopyear=2019, height=3pt, dates=false, arrow=false, align=center]
    \definechronoevent{sp}[textstyle=\footnotesize, datesseparation=/, conversionmonth=false]
    \chronosp[markdepth=-15pt]{06/2005}{\cite{Ding:200506:inproc}~\ref{enum:ii}}
    \chronosp[markdepth=-50pt]{04/2006}{\cite{Yang:200604:inproc}~\ref{enum:iii}}
    \chronosp[markdepth=5pt]{09/2006}{\cite{Billet:200609:inproc}~\ref{enum:iv}}
    \chronosp[markdepth=5pt]{06/2008}{\cite{Ding:200806:inproc}~\ref{enum:iv}}
    \chronosp[markdepth=-50pt]{06/2010}{\cite{Petzoldt:201006:inproc}~\ref{enum:ii}}
    \chronosp[markdepth=5pt]{12/2010}{\cite{Petzoldt:201012:inproc}~\ref{enum:i}}
    \chronosp[markdepth=-15pt]{03/2011}{\cite{Petzoldt:201103:inproc}~\ref{enum:ii}}
    \chronosp[markdepth=80pt]{02/2012}{\cite{Yasuda:201202:inproc}~\ref{enum:iii}}
    \chronosp[markdepth=-85pt]{09/2012}{\cite{Thomae:201209:inproc}~\ref{enum:iv}}
    \chronosp[markdepth=45pt]{11/2012}{\cite{Petzoldt:201211:inproc}~\ref{enum:i}}
    \chronosp[markdepth=-50pt]{02/2013}{\cite{Hashimoto:201302:inproc}~\ref{enum:iv}}
    \chronosp[markdepth=5pt]{05/2013}{\cite{Yasuda:201305:inproc}~\ref{enum:ii}}
    \chronosp[markdepth=-15pt]{07/2013}{\cite{Petzoldt:201307:phd}~\ref{enum:i}}
    \chronosp[markdepth=45pt]{04/2014}{\cite{Yasuda:201404:inproc}~\ref{enum:ii}}
    \chronosp[markdepth=-50pt]{09/2014}{\cite{Yasuda:201409:article}~\ref{enum:ii}}
    \chronosp[markdepth=5pt]{12/2015}{\cite{Shim:201512:inproc}~\ref{enum:i}}
    \chronosp[markdepth=45pt]{06/2017}{\cite{Beullens:201706:msc}~\ref{enum:i}}
    \chronosp[markdepth=-50pt]{06/2017}{\cite{Peng:201706:article}~\ref{enum:iii}}
    \chronosp[markdepth=5pt]{06/2017}{\cite{Szepieniec:201706:inproc}~\ref{enum:i}}
    \chronosp[markdepth=-15pt]{12/2017}{\cite{Beullens:201712:inproc}~\ref{enum:i}}
    \chronosp[markdepth=5pt]{10/2018}{\cite{Hashimoto:201810:misc}~\ref{enum:iv}}
  \end{chronology}
...
However, these schemes were either broken, as summarised by the authors
...
Additionally, there have been several published variations of Rainbow with the
same goal, making use of distinct approaches. A scheme called
Lite-Rainbow-0~\cite{Shim:201512:inproc} makes use of a small pseudorandom
...
insecure~\cite{Thomae:201207:inproc,Hashimoto:201302:inproc}. Other variants
...
after~\cite{Hashimoto:201810:misc}.

It is also relevant to cite the approach by the authors
of~\cite{Petzoldt:201006:inproc}, which is, to the best of our knowledge, the
main method for public key reduction without compromises to the signature size.
It is summarised in several
publications~\cite{Petzoldt:201012:inproc,Petzoldt:201103:inproc,Petzoldt:201211:inproc}.
However, these cannot be combined with the private key improvements previously
cited. Furthermore, it appears that the introduction of structures in the
private key is highly threatening to the overall security of a Rainbow scheme.
We will subsequently present a novel approach to these issues.
