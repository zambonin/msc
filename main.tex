...
Recall that $\widetilde{V_{1}}$ is the sequence of vinegar variables used on the signature generation algorithm of Rai
Let $\mathbf{v} \in \mathbb{F}_{2}^{v_{1}}$ be the \emph{vinegar threshold}, that is, a bit string that denotes which elements from $\widetilde{V_{1}}$ are to be fixed.
