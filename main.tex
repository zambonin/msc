...
For instance, the ring of integers equipped with usual addition and multiplication $(\mathbb{Z}, +, \times)$ is a commutative unit ring. The quaternions, a very common number system employed in three-dimensional computer graphics, form a noncommutative division ring with the usual binary operations.
