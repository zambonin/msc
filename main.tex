...
\begin{definition}
  Let $\widetilde{\mathsf{MQ}}(n, m)$ be a class of structured polynomial maps. Given a $3$-tuple $(\mathcal{L}_{1}, \mathcal{C}, \mathcal{L}_{2}) \in \mathsf{GL}_{n}(\mathbb{F}) \times \widetilde{\mathsf{MQ}}(n, m) \times \mathsf{GL}_{m}(\mathbb{F})$ such that $\mathcal{P} = \mathcal{L}_{1} \circ \mathcal{C} \circ \mathcal{L}_{2}$, finding a decomposition $\mathcal{P} = \widetilde{\mathcal{L}_{1}} \circ \widetilde{\mathcal{C}} \circ \widetilde{\mathcal{L}_{2}}$ also with $(\widetilde{\mathcal{L}_{1}}, \widetilde{\mathcal{C}}, \widetilde{\mathcal{L}_{2})} \in \mathsf{GL}_{n}(\mathbb{F}) \times \widetilde{\mathsf{MQ}}(n, m) \times \mathsf{GL}_{m}(\mathbb{F})$ is called the \emph{extended isomorphism of polynomials problem}.
\end{definition}


what is called the extended isomorphism of polynomials (EIP)
