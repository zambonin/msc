...
However, we have to account for $\mathcal{L}_{2}$, since it is composed with $\mathcal{C}$ to form the public key.

% Remarkably, this behaviour is unchanged for any combination of polynomials of $\mathcal{P}$, as argued in~\cite[p.~261]{Kipnis:199808}.
