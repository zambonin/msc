...
While it is evident that Rainbow is the most known multivariate signature scheme based on Oil--Vinegar polynomials, schemes in that class that feature 
Schemes based on multivariate cryptography with modifications that enable the reduction of key sizes have been suggested even before Rainbow was
