...
It is argued in~\cite[Lemmata 3.2, 3.10, 3.19]{Thomae:201306} that some IP-class problems are no harder to solve if $\mathcal{L}_{1}$ and $\mathcal{L}_{2}$ are linear instead of affine transformations. As a consequence, such results need the polynomials in the central map to be homogeneous quadratic. We make use of this technical result and present a coherent description of the schemes in Section~\ref{sec:ov}.
