...
\begin{theorem}[{\cite[Theorem 2]{Beullens:201706}}]
  ...
  \begin{align}
    ...
    \end{bmatrix},
  \end{align}
  with $\mathcal{L}_{2}^{(1)} \in \mathsf{GL}_{v}(\mathbb{F})$, then
  \begin{align}
  ...
  \begin{split}
    ...
    \begin{dcases}
      \begin{bmatrix}
        ...
        \mathbf{0}_{o_{2} \times v_{1}} & \mathbf{0}_{o_{2} \times o_{2}} & \mathbf{0}_{o_{2} \times o_{2}} \\
      ...
      \begin{bmatrix}
        ...
        \star_{o_{2} \times v_{1}}      & \mathbf{0}_{o_{2} \times o_{2}} & \mathbf{0}_{o_{2} \times o_{2}} \\
...
\begin{theorem}[{\cite[Theorem 4.17]{Wolf:201104}}]
  Without loss of generality, given a private key $(\mathcal{L}_{1}, \mathcal{C}, \mathcal{L}_{2}) \in \mathsf{GL}(\mathbb{F}^{m}) \times \mathsf{RB}(v_{1}, o_{1}, \dots, o_{u}) \times \mathsf{GL}(\mathbb{F}^{m})$ with $u = 2$, $\tau \in \mathsf{GL}(\mathbb{F}^{m}), \; \omega \in \mathsf{GL}(\mathbb{F}^{n})$ with matrix representations of the form
  \begin{align}
    \begin{bmatrix}
      \tau_{o_{1} \times o_{1}}^{(1)} & \mathbf{0}_{o_{1} \times o_{2}} \\
      \tau_{o_{2} \times o_{2}}^{(2)} & \tau_{o_{1} \times o_{2}}^{(3)} \\
    \end{bmatrix},
    \begin{bmatrix}
      ...
      \omega_{o_{2} \times v_{1}}^{(4)} & \omega_{o_{2} \times o_{2}}^{(5)} & \omega_{o_{2} \times o_{2}}^{(6)} \\
    \end{bmatrix},    
  \end{align}
  and $\tau^{(1)} \in \mathsf{GL}_{o_{1}}(\mathbb{F}), \tau^{(3)}$, then $(\mathcal{L}_{1} \circ \tau^{-1}, \tau \circ \mathcal{C} \circ \omega, \omega^{-1} \circ \mathcal{L}_{2}$ is an equivalent private key.
\end{theorem}
