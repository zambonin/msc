...
\begin{table}[htbp]
  ...
  \setlength{\tabcolsep}{7pt}
  \centering
  \caption{Probabilities of guessing a signature depending on the Hamming weight of 
  the vinegar threshold.}\label{tab:bin-prob}
  \begin{tabular}{*{7}{r}}
    \toprule
