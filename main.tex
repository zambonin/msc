...
A similar idea introduced at roughly the same time are \emph{tame transformation schemes} (TTS), in which sparseness is directly introducted into the private key. This strategy remained unbroken for a longer period than STS. In this 
