...
We conclude that signatures produced with Rainbow-$\eta$ are statistically indistinguishable from conventional Rainbow signatures, preventing related attacks. The method allows for a reasonable reduction in private key sizes and 
