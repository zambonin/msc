...
A vibrant discipline of cryptography, signature schemes are often associated with digital systems, in which transit of sensitive messages is expected to be secure. Indeed, even basic computers are able to perform operations analogous to the creation and verification of a signature. Thus, it is expected that advances in computer engineering present direct consequences on the performance and security of such schemes. 
