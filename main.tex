...
\begin{definition}
  ...
  \end{align}
  then $\mathbf{X}$ follows the \emph{binomial distribution}. This distribution has mean $\mu = np$ and standard deviation $\sigma = \sqrt{np(1 - p)}$.
\end{definition}

% $\mathbf{v}$ will follow  binomial distribution with $n = v_{1}$ and $p = 0.5$. 
