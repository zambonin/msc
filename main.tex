...
\begin{theorem}[{\cite[Theorem 4.17]{Wolf:201104}}]
  ...
  \begin{align}
    ...
    \end{bmatrix},    
  \end{align}
  and $\tau^{(1)} \in \mathsf{GL}_{o_{1}}(\mathbb{F}), \tau^{(3)} \in \mathsf{GL}_{o_{2}}(\mathbb{F}), \omega^{(1)} \in \mathsf{GL}_{v_{1}}(\mathbb{F}), \omega^{(3)} \in \mathsf{GL}_{o_{1}}(\mathbb{F})$, then $(\mathcal{L}_{1} \circ \tau^{-1}, \tau \circ \mathcal{C} \circ \omega, \omega^{-1} \circ \mathcal{L}_{2}$ is an equivalent private key.
\end{theorem}
