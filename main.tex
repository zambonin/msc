...
\end{align}
The size of a public key is the number of elements in the matrices associated with the homogeneous quadratic forms of all polynomials in the system, as per Equation~\ref{}, or
\begin{align}
