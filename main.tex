...
Most modern multivariate cryptography schemes are based on multivariate quadratic equations over finite fields, that is, polynomial systems with $\deg(\cdot) = 2$. This is due to the fact that obtaining secret information from a public key, which is expected to look like a random polynomial system, is proven NP-hard for quadratic systems~\cite{}. Consequently, operating on polynomials of lower degrees is more efficients
